...
export namespace Prisma {
  ...
  */
  ...
  export type ManagerOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"hospitalId" | "name" | "password", ExtArgs["result"]["manager"]>
  ...
  export interface ManagerDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, ClientOptions = {}> {
     ...
     * const managerWithHospitalIdOnly = await prisma.manager.findMany({ select: { hospitalId: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Managers and only return the `hospitalId`
     * const managerWithHospitalIdOnly = await prisma.manager.createManyAndReturn({
     ...
     * })
     * 
     * // Update zero or more Managers and only return the `hospitalId`
     * const managerWithHospitalIdOnly = await prisma.manager.updateManyAndReturn({
     *   select: { hospitalId: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface ManagerFieldRefs {
    readonly hospitalId: FieldRef<"Manager", 'Int'>
  ...
  export type AdminOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"adminId" | "name" | "password", ExtArgs["result"]["admin"]>
  ...
  export type ManagerWhereInput = {
    ...
    hospitalId?: IntFilter<"Manager"> | number
  ...
  export type ManagerScalarWhereWithAggregatesInput = {
    ...
    hospitalId?: IntWithAggregatesFilter<"Manager"> | number
