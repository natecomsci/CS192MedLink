...
export const POST: RequestHandler = async ({ request, cookies }) => {
  ...
  let { results, currentPage, totalPages } = await updateLogDAO.getPaginatedUpdateLogsByFacility(facilityID, newPageNumber, facilityUpdateLogsPageSize, { createdAt: "desc" })
